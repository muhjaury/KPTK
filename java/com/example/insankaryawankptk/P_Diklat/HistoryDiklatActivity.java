...
public class HistoryDiklatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_diklat);
        ...
        //Diklat Adapter Model
        recyclerView = findViewById(R.id.rv_diklat);
            ...
            public void onResponse(JSONArray response) {
                for (int i = 0;i < response.length();i++){
                    try {
                        ...
                        diklatAdapter = new DiklatAdapter(HistoryDiklatActivity.this, diklatModels);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(HistoryDiklatActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    private String prepareGetMethodUrl() {
        ...
        return URL_DATA + "?pname=" + pname + "&token=" + token + "&unique="+ unique + "&cek=" + hash + "&date=" + randomAlphaNumeric(50);
    }
